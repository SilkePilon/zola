...
const mistralModels: ModelConfig[] = [
  ...
  },
  {
    ...
    baseProviderId: "mistral",
    modelFamily: "Mixtral",
    description: "Open-weight mixture-of-experts model (8x7B)",
    tags: ["open-source", "moe", "balanced"],
    contextWindow: 32768,
    inputCost: 0.0,
    outputCost: 0.0,
    priceUnit: "per 1M tokens",
    ...
    apiDocs: "https://docs.mistral.ai/getting-started/models",
    modelPage: "https://mistral.ai/news/mixtral/",
    icon: "mistral",
    apiSdk: (apiKey?: string) =>
      openproviders("open-mixtral-8x7b", undefined, apiKey),
  },
  {
    ...
    baseProviderId: "mistral",
    modelFamily: "Mixtral",
    description: "Larger open-weight mixture-of-experts model (8x22B)",
    tags: ["open-source", "moe", "large"],
    contextWindow: 32768,
    inputCost: 0.0,
    outputCost: 0.0,
    priceUnit: "per 1M tokens",
    ...
    icon: "mistral",
    apiSdk: (apiKey?: string) =>
      openproviders("open-mixtral-8x22b", undefined, apiKey),
  },
  {
