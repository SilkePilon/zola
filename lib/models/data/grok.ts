...
const grokModels: ModelConfig[] = [
  ...
  },
  {
    ...
    modelFamily: "Grok",
    baseProviderId: "xai",
    description: "Latest Grok 3 snapshot with iterative improvements.",
    tags: ["latest", "reasoning", "balanced"],
    ...
    icon: "xai",
    apiSdk: (apiKey?: string) => openproviders("grok-3-latest", undefined, apiKey),
  },
  {
    ...
    modelFamily: "Grok",
    baseProviderId: "xai",
    description: "Latest fast mini Grok for responsive applications.",
    tags: ["mini", "fast", "latest"],
    contextWindow: 32000,
    inputCost: 0.25,
    outputCost: 1.0,
    priceUnit: "per 1M tokens",
    ...
    apiSdk: (apiKey?: string) =>
      openproviders("grok-3-mini-fast-latest", undefined, apiKey),
  },
  {
    id: "grok-2-vision",
    name: "Grok 2 Vision",
